...
class GrainsTest(unittest.TestCase):
    ...
    def test_timeit(self):
        print(timeit('total_after(64, True)', setup='from grains import total_after', number=10000))
        print(timeit('total_after(64, False)', setup='from grains import total_after', number=10000))
